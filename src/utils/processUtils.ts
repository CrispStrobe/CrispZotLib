  ...
  static async executeCommand(
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        const stdout = Components.classes["@mozilla.org/pipe;1"].createInstance(
          Components.interfaces.nsIPipe,
        );
        stdout.init(false, false, 0, 0, null);

        const stderr = Components.classes["@mozilla.org/pipe;1"].createInstance(
          Components.interfaces.nsIPipe,
        );
