...
export async function openSearchDialog(): Promise<void> {
  ...
  const dialogHelper = createStyledDialog(12, 2)
    ...
    .addCell(1, 0, {
      ...
      namespace: "html",
      styles: { gridColumn: "1 / span 2" },
      properties: { innerHTML: getString("search-dialog-description") },
    })
    .addCell(2, 0, {
      tag: "label",
      namespace: "html",
      properties: { textContent: getString("search-dialog-protocol") },
    })
    .addCell(2, 1, {
      tag: "div",
      namespace: "html",
          ...
          children: [
            {
              ...
              attributes: {
                ...
                value: "ixtheo",
                checked:
                  dialogData.protocol === "ixtheo" ? "checked" : undefined,
              },
            },
            {
              tag: "label",
    ...
    .addCell(3, 0, {
      tag: "label",
      namespace: "html",
      properties: { textContent: getString("search-dialog-endpoint") },
    })
    .addCell(3, 1, {
      tag: "div",
      namespace: "html",
      children: [
        {
          ...
          id: "endpoint-sru",
          styles: { width: "100%" },
          children: Object.entries(SRU_ENDPOINTS).map(([key, details]) => ({
            tag: "option",
            namespace: "html",
            properties: {
              value: key,
              innerHTML: details.name,
              selected:
                dialogData.endpoint === key && dialogData.protocol === "sru",
            },
          })),
        },
        {
          ...
          id: "endpoint-oai",
          styles: { width: "100%" },
          children: Object.entries(OAI_ENDPOINTS).map(([key, details]) => ({
            tag: "option",
            namespace: "html",
            properties: {
              value: key,
              innerHTML: details.name,
              selected:
                dialogData.endpoint === key && dialogData.protocol === "oai",
            },
          })),
        },
        {
          ...
          id: "endpoint-ixtheo",
          styles: { width: "100%" },
          children: Object.entries(IXTHEO_ENDPOINTS).map(([key, details]) => ({
            tag: "option",
            namespace: "html",
            properties: {
              value: key,
              innerHTML: details.name,
              selected:
                dialogData.endpoint === key && dialogData.protocol === "ixtheo",
            },
          })),
        },
      ],
    ...
    .addCell(4, 0, {
      tag: "div",
      id: "schema-row",
      styles: { gridColumn: "1 / span 2", marginTop: "10px" },
      children: [
        {
          tag: "div",
    ...
    .addCell(5, 0, {
      tag: "div",
      id: "oai-options-container",
      styles: {
        gridColumn: "1 / span 2",
        border: "1px solid var(--ls-border-color, #555)",
        padding: "10px",
        marginTop: "10px",
        borderRadius: "4px",
      ...
      children: [
        {
          tag: "h3",
          properties: { innerHTML: "OAI-PMH Options" },
          styles: { marginTop: 0, marginBottom: "5px" },
        },
        {
          tag: "div",
          styles: { display: "flex", alignItems: "center", gap: "10px" },
          children: [
            {
              tag: "label",
              namespace: "html",
              attributes: { for: "oai-set" },
              properties: { innerHTML: getString("search-dialog-oai-set") },
              styles: { width: "100px", flexShrink: 0 },
            },
            ...
            // a button text for "List Sets"
            {
              tag: "button",
              namespace: "html",
              id: "oai-list-sets-button",
              properties: { innerHTML: "List Sets" },
            },
          ],
        },
        {
          ...
          children: [
            {
              tag: "label",
              namespace: "html",
              attributes: { for: "oai-prefix" },
              properties: { innerHTML: getString("search-dialog-oai-prefix") },
              styles: { width: "100px", flexShrink: 0 },
            },
            {
              tag: "input",
              namespace: "html",
              id: "oai-prefix",
              attributes: { type: "text", value: dialogData.oaiPrefix },
              styles: { flexGrow: 1 },
              listeners: [
                {
                  type: "input",
          ...
          children: [
            {
              tag: "label",
              namespace: "html",
              attributes: { for: "oai-from" },
              properties: { innerHTML: getString("search-dialog-oai-from") },
              styles: { width: "100px", flexShrink: 0 },
            },
            {
              tag: "input",
              namespace: "html",
              id: "oai-from",
              attributes: { type: "date", value: dialogData.oaiFrom },
              styles: { flexGrow: 1, minWidth: "120px" },
              listeners: [
                {
                  type: "input",
                  listener: (e: Event) => {
                    dialogData.oaiFrom = (e.target as HTMLInputElement).value;
                  },
                },
              ],
            },
            {
              tag: "label",
              namespace: "html",
              attributes: { for: "oai-until" },
              properties: { innerHTML: getString("search-dialog-oai-until") },
              styles: { marginLeft: "10px", width: "auto" },
            },
            {
              tag: "input",
              namespace: "html",
              id: "oai-until",
              attributes: { type: "date", value: dialogData.oaiUntil },
              styles: { flexGrow: 1, minWidth: "120px" },
              listeners: [
                {
                  type: "input",
                  listener: (e: Event) => {
                    dialogData.oaiUntil = (e.target as HTMLInputElement).value;
                  },
                },
              ],
            },
    ...
    .addCell(6, 1, {
      ...
      namespace: "html",
      id: "title",
      attributes: { type: "text", value: dialogData.title },
      styles: { width: "100%" },
      listeners: [
        {
          type: "input",
    ...
    .addCell(7, 1, {
      ...
      namespace: "html",
      id: "author",
      attributes: { type: "text", value: dialogData.author },
      styles: { width: "100%" },
      listeners: [
        {
          type: "input",
    ...
    .addCell(8, 1, {
      ...
      namespace: "html",
      id: "isbn",
      attributes: { type: "text", value: dialogData.isbn },
      styles: { width: "100%" },
      listeners: [
        {
          type: "input",
    ...
    .addCell(10, 0, {
      ...
      namespace: "html",
      id: "all-fields-label",
      attributes: { for: "all-fields-term" },
      ...
      listeners: [
        {
          type: "input",
          listener: (e: Event) => {
            dialogData.allFieldsTerm = (e.target as HTMLInputElement).value;
          },
        },
      ],
    })
    ...
    .addButton(getString("search-dialog-search-button"), "search", {
      callback: async (e: Event) => {
        ...
        if (dialogHelper.window) {
          ...
          const selectedProtocolEl = doc.querySelector(
          ...
          const endpointSelect = doc.getElementById(
            endpointSelectId,
          ...
          } else if (endpointSelect && endpointSelect.options.length > 0) {
            dialogData.endpoint =
              (endpointSelect.options[0] as HTMLOptionElement)?.value || "";
          } else {
            dialogData.endpoint = "";
          }
          ...
          const allFieldsInput = doc.getElementById(
            "all-fields-term",
          ) as HTMLInputElement | null;
          dialogData.allFieldsTerm = allFieldsInput ? allFieldsInput.value : "";

          if (dialogData.protocol === "sru") {
            const selectedSchemaEl = doc.querySelector(
              'input[name="schema"]:checked',
            ) as HTMLInputElement | null;
            dialogData.schema = selectedSchemaEl ? selectedSchemaEl.value : "";
            const titleInput = doc.getElementById(
              "title",
            ) as HTMLInputElement | null;
            dialogData.title = titleInput ? titleInput.value : "";
            const authorInput = doc.getElementById(
              "author",
            ) as HTMLInputElement | null;
            dialogData.author = authorInput ? authorInput.value : "";
            const isbnInput = doc.getElementById(
              "isbn",
            ) as HTMLInputElement | null;
            dialogData.isbn = isbnInput ? isbnInput.value : "";
            dialogData.oaiSet = undefined;
            dialogData.oaiPrefix = undefined;
            dialogData.oaiFrom = undefined;
            dialogData.oaiUntil = undefined;
          } else if (dialogData.protocol === "oai") {
            const setSelect = doc.getElementById(
              "oai-set",
            ) as HTMLSelectElement | null;
            dialogData.oaiSet = setSelect ? setSelect.value : undefined;
            const prefixInput = doc.getElementById(
              "oai-prefix",
            ) as HTMLInputElement | null;
            dialogData.oaiPrefix = prefixInput ? prefixInput.value : undefined;
            const fromInput = doc.getElementById(
              "oai-from",
            ) as HTMLInputElement | null;
            dialogData.oaiFrom = fromInput ? fromInput.value : undefined;
            const untilInput = doc.getElementById(
              "oai-until",
            ) as HTMLInputElement | null;
            dialogData.oaiUntil = untilInput ? untilInput.value : undefined;
            dialogData.title = "";
            dialogData.author = "";
            dialogData.isbn = "";
            dialogData.allFieldsTerm = "";
            dialogData.schema = "";
        ...
        if (!dialogData.endpoint) {
          dialogHelper.window?.alert(
            getString("search-error-missing-endpoint"),
          );
          return;
        }
        if (
          ...
          dialogHelper.window?.alert(
            getString("search-error-missing-search-terms"),
          );
          return;
        }
        if (dialogData.protocol === "oai" && !dialogData.oaiPrefix) {
          dialogHelper.window?.alert(
            "Metadata Prefix is required for OAI-PMH search.",
          );
          return;
        }
        if (dialogData.protocol === "ixtheo") {
          ...
          if (
            !dialogData.title?.trim() &&
            !dialogData.author?.trim() &&
            !dialogData.isbn?.trim() &&
            !dialogData.allFieldsTerm?.trim()
          ) {
            dialogHelper.window?.alert(
              getString("search-error-missing-search-terms"),
            );
        ...
        const searchButton = dialogHelper.window?.document?.getElementById(
          "search",
        ...
        try {
          const searchParams: SearchParams = {
            ...
            set: dialogData.oaiSet,
            metadataPrefix: dialogData.oaiPrefix,
            from: dialogData.oaiFrom,
            until: dialogData.oaiUntil,
          ...
          const [success, results, totalRecords, initialOaiToken] =
            await LibrarySearchIntegration.executeSearch(searchParams);
          if (success && results && results.length > 0) {
            addon.data.lastSearchResults = results;
            const searchDialogRef = addon.data.dialog;
            addon.data.dialog = undefined;
            if (searchDialogRef?.window && !searchDialogRef.window.closed) {
              searchDialogRef.window.close();
            }
            await LibrarySearchIntegration.openResultsDialog(
              results,
              totalRecords,
              searchParams,
              initialOaiToken,
          ...
          dialogData.errorMessage =
            error?.message || getString("search-dialog-error");
          dialogHelper.window?.alert(
            `Search Error: ${dialogData.errorMessage}`,
          );
        } finally {
    ...
    .addButton("Import by Identifier", "resolve-id", {
      ...
      callback: async () => {
        ...
        const input = win.prompt(
          "Enter a DOI, PMID, ISBN, or URL to resolve and import:",
        );
        if (!input || !input.trim()) return;
        const identifier = input.trim();
        if (!detectIdentifierType(identifier)) {
          win.alert(
            `"${identifier}" doesn't look like a DOI, PMID, ISBN, or URL.`,
          );
          return;
        }
        ...
        try {
          ...
          win.alert(
            count > 0
              ? `Imported: ${record.title}`
              : `Could not import "${identifier}".`,
          );
        } catch (e: any) {
          ztoolkit.log(
            `[LibrarySearch] Identifier import failed: ${e?.message || e}`,
            "error",
          );
          ...
          if (btn) {
            btn.disabled = false;
            btn.textContent = "Import by Identifier";
          }
        }
      },
    })
  ...
  if (dialogHelper.window) {
    ...
    ztoolkit.log(
      "Initialization: Window object found after open(), attaching DOMContentLoaded listener...",
    );
    ...
    win.addEventListener("DOMContentLoaded", () => {
      ...
      const sruEndpointSelect = doc.getElementById(
        "endpoint-sru",
      ) as HTMLSelectElement | null;
      const oaiEndpointSelect = doc.getElementById(
        "endpoint-oai",
      ) as HTMLSelectElement | null;
      const ixtheoEndpointSelect = doc.getElementById(
        "endpoint-ixtheo",
      ) as HTMLSelectElement | null;
      const protocolRadios = doc.querySelectorAll(
        'input[name="protocol"]',
      ...
      const listSetsButton = doc.getElementById(
        "oai-list-sets-button",
      ) as HTMLButtonElement | null;
      const oaiPrefixInput = doc.getElementById(
        "oai-prefix",
      ) as HTMLInputElement | null;
      ...
      const updateVisibility = (protocol: string) => {
        ztoolkit.log(
          `${logPrefix} Updating visibility for protocol: ${protocol}`,
        );
        // Get references *inside* function to ensure they are fresh if DOM changes (though unlikely here)
        const sruSelect = doc.getElementById(
          "endpoint-sru",
        ) as HTMLElement | null;
        const oaiSelect = doc.getElementById(
          "endpoint-oai",
        ) as HTMLElement | null;
        const ixtheoSelect = doc.getElementById(
          "endpoint-ixtheo",
        ) as HTMLElement | null;
        const schemaRow = doc.getElementById(
          "schema-row",
        ) as HTMLElement | null;
        const titleLabel = doc.getElementById(
          "title-label",
        ) as HTMLElement | null;
        const titleInput = doc.getElementById("title") as HTMLElement | null;
        const authorLabel = doc.getElementById(
          "author-label",
        ) as HTMLElement | null;
        const authorInput = doc.getElementById("author") as HTMLElement | null;
        const isbnLabel = doc.getElementById(
          "isbn-label",
        ) as HTMLElement | null;
        const isbnInput = doc.getElementById("isbn") as HTMLElement | null;
        const oaiOptionsContainer = doc.getElementById(
          "oai-options-container",
        ) as HTMLElement | null;
        const allFieldsLabel = doc.getElementById(
          "all-fields-label",
        ) as HTMLElement | null;
        const allFieldsInput = doc.getElementById(
          "all-fields-term",
        ) as HTMLElement | null;
        const maxResultsLabel = doc.getElementById(
          "max-results-label",
        ) as HTMLElement | null;
        const maxResultsInput = doc.getElementById(
          "maxResults",
        ) as HTMLElement | null;
        const debugLabel = doc.querySelector(
          'label[for="debug-mode"]',
        ) as HTMLElement | null;
        const debugInput = doc.getElementById(
          "debug-mode",
        ) as HTMLElement | null;
        ...
        if (protocol === "sru") {
          if (sruSelect) {
            sruSelect.style.display = "";
            currentEndpointSelect = sruSelect as HTMLSelectElement;
          }
          if (schemaRow) schemaRow.style.display = "";
          [...specificFields, ...allFieldsGroup].forEach((el) => {
            if (el) el.style.display = "";
          });
        } else if (protocol === "oai") {
          if (oaiSelect) {
            oaiSelect.style.display = "";
            currentEndpointSelect = oaiSelect as HTMLSelectElement;
          }
          oaiFields.forEach((el) => {
            if (el) el.style.display = "";
          });
          if (listSetsButton)
            listSetsButton.disabled = !currentEndpointSelect?.value; // Disable if no endpoint selected
        } else if (protocol === "ixtheo") {
          if (ixtheoSelect) {
            ixtheoSelect.style.display = "";
            currentEndpointSelect = ixtheoSelect as HTMLSelectElement;
          }
          [...specificFields, ...allFieldsGroup].forEach((el) => {
            if (el) el.style.display = "";
          });
        ...
        if (currentEndpointSelect?.value) {
          ...
          ztoolkit.log(
            `${logPrefix} Updated endpoint data to: ${dialogData.endpoint}`,
          );
        } else if (
          currentEndpointSelect &&
          currentEndpointSelect.options.length > 0
        ) {
          // Fallback if no value but options exist (select first)
          dialogData.endpoint =
            (currentEndpointSelect.options[0] as HTMLOptionElement)?.value ||
            "";
          currentEndpointSelect.selectedIndex = 0;
          ztoolkit.log(
            `${logPrefix} No endpoint selected, defaulting to first: ${dialogData.endpoint}`,
          );
        } else {
          dialogData.endpoint = "";
          ztoolkit.log(
            `${logPrefix} Cleared endpoint data (no select/options for protocol ${protocol}).`,
          );
        }

        // 6. Clear schema if not SRU
        if (protocol !== "sru") {
          if (dialogData.schema) {
            // Only log if it was actually cleared
            ztoolkit.log(
              `${logPrefix} Clearing schema as protocol is not SRU.`,
            );
            dialogData.schema = "";
            const schemaRadios = doc.querySelectorAll(
              'input[name="schema"]',
            ) as NodeListOf<HTMLInputElement>;
            schemaRadios.forEach(
        ...
        if (protocol === "oai") {
          ...
          dialogData.oaiPrefix =
            endpointDetails?.defaultMetadataPrefix || "oai_dc";
          if (oaiPrefixInput) oaiPrefixInput.value = dialogData.oaiPrefix;
          ztoolkit.log(
            `${logPrefix} Updated OAI prefix based on endpoint: ${dialogData.oaiPrefix}`,
          );
        }
      ...
      ztoolkit.log(
        `${logPrefix} Found ${protocolRadios.length} protocol radios.`,
      );
      protocolRadios.forEach((radio: HTMLInputElement) => {
        ...
        radio.addEventListener("change", (e: Event) => {
          ...
          if (target.checked) {
            ...
            ztoolkit.log(
              `${logPrefix} New protocol selected: ${dialogData.protocol}`,
            );
            ...
            if (dialogData.protocol === "oai" && setInput) {
              ztoolkit.log(
                `${logPrefix} Resetting OAI set field due to protocol change.`,
              );
              setInput.value = "";
      ...
      const handleEndpointChange = (
        e: Event,
        protocol: "sru" | "oai" | "ixtheo",
      ) => {
        if (dialogData.protocol === protocol) {
          dialogData.endpoint = (e.target as HTMLSelectElement).value;
          ztoolkit.log(
            `${logPrefix} ${protocol.toUpperCase()} endpoint changed to: ${dialogData.endpoint}`,
          );
          ...
          if (protocol === "oai") {
            ...
            if (oaiPrefixInput) oaiPrefixInput.value = dialogData.oaiPrefix;
            ztoolkit.log(
              `${logPrefix} Updated OAI prefix for new endpoint: ${dialogData.oaiPrefix}`,
            );
            // Reset the set input as the sets are specific to the endpoint
            if (setInput) {
              ztoolkit.log(
                `${logPrefix} Resetting OAI set field due to endpoint change.`,
              );
              setInput.value = "";
              dialogData.oaiSet = ""; // Clear data model value
            }
      ...
      if (sruEndpointSelect)
        sruEndpointSelect.addEventListener("change", (e) =>
          handleEndpointChange(e, "sru"),
        );
      if (oaiEndpointSelect)
        oaiEndpointSelect.addEventListener("change", (e) =>
          handleEndpointChange(e, "oai"),
        );
      if (ixtheoEndpointSelect)
        ixtheoEndpointSelect.addEventListener("change", (e) =>
          handleEndpointChange(e, "ixtheo"),
        );
      ...
      if (listSetsButton && setInput && oaiEndpointSelect) {
        ...
        listSetsButton.addEventListener("click", async () => {
          ...
          if (dialogData.protocol !== "oai") {
            ztoolkit.log(
              `${logPrefix} List Sets clicked, but OAI protocol not active. Ignoring.`,
              "warn",
            );
            return;
          }
          ...
          if (!endpointKey) {
            ...
            win.alert(
              typeof getString === "function"
                ? getString("search-dialog-oai-error-no-endpoint")
                : "Please select an OAI endpoint first.",
            );
            return;
          }
          ...
          if (!endpointDetails?.url) {
            ztoolkit.log(
              `${logPrefix} Endpoint URL not found for key: ${endpointKey}`,
              "error",
            );
            win.alert(
              `Configuration error: Endpoint URL not found for key: ${endpointKey}`,
            );
            return;
          }
          ...
          listSetsButton.textContent =
            typeof getString === "function"
              ? getString("search-dialog-oai-loading-sets")
              : "Loading...";
          ...
          try {
            ...
            if (!client) {
              ztoolkit.log(
                `${logPrefix} Creating new OAIClient for ${endpointKey}`,
              );
              client = new OAIClient(
                endpointDetails.url,
                endpointDetails.defaultMetadataPrefix,
              );
            }
            ...
            ztoolkit.log(
              `${logPrefix} OAI listSets returned ${setCount} sets.`,
            );
            ...
            ztoolkit.log(
              `${logPrefix} Error fetching or parsing OAI sets: ${error.message}`,
              "error",
            );

            // Show alert with error message
            win.alert(
              `Failed to fetch OAI sets for ${endpointDetails.name}: ${error.message || "Unknown error"}`,
            );
          } finally {
            // Reset button state
      ...
      if (setInput) {
        setInput.addEventListener("input", (e) => {
          dialogData.oaiSet = (e.target as HTMLInputElement).value;
          ztoolkit.log(
            `${logPrefix} OAI Set manually changed to: ${dialogData.oaiSet}`,
          );
        });
      }
      if (oaiPrefixInput) {
        oaiPrefixInput.addEventListener("change", (e) => {
          dialogData.oaiPrefix = (e.target as HTMLInputElement).value;
          ztoolkit.log(
            `${logPrefix} OAI Prefix manually changed to: ${dialogData.oaiPrefix}`,
          );
        });
      }
      ...
      function openSetsSelectionDialog(
        ...
        const updateSetsList = (
          ...
          try {
            ...
            if (!container) {
              ...
              ztoolkit.log(
                "Error: Sets container not found in OAI sets dialog.",
                "error",
              );
              return;
            }
            ...
            const setEntries = Object.entries(sets).filter(([spec, name]) => {
              if (!filterValue) return true;
              return (
                spec.toLowerCase().includes(lowerFilter) ||
                name.toLowerCase().includes(lowerFilter)
              );
            });

            // Fix 2: Assert getElementById returns HTMLElement or null for info area
            const infoArea = doc.getElementById(
              "selection-info",
            ) as HTMLElement | null;
            ...
            if (setEntries.length === 0) {
              ...
              if (infoArea) {
                // OK: infoArea is HTMLElement | null
                infoArea.textContent = filterValue
            ...
            list.setAttribute(
              "aria-label",
              `Available sets for ${endpointName}`,
            ...
            setEntries.forEach(([spec, name]) => {
              ...
              item.style.backgroundColor =
                "var(--ls-secondary-background-color, var(--zotero-background-secondary, #f7f7f7))"; // OK
              ...
              if (name) {
                ...
                specSpan.style.color =
                  "var(--ls-text-secondary-color, var(--zotero-text-secondary, #555))"; // OK
              ...
              item.addEventListener("click", () => {
                ...
                container
                  .querySelectorAll<HTMLDivElement>("div[data-spec]")
                ...
                item.style.borderLeftColor =
                  "var(--ls-accent-color, var(--zotero-link-color, #0366d6))"; // OK
                item.style.backgroundColor =
                  "var(--ls-highlight-color, var(--zotero-background-selected, #e8f1fa))"; // OK
            ...
            if (
              selectedSetSpec &&
              !setEntries.some(([spec]) => spec === selectedSetSpec)
            ) {
              selectedSetSpec = null;
              if (selectButton) selectButton.disabled = true;
              if (infoArea) {
            ...
            ztoolkit.log(
              `Error updating OAI sets list: ${e?.message || e}`,
              "error",
            );
          }
        };
        ...
        dialogHelper.addCell(1, 0, {
          tag: "p",
          properties: {
            innerHTML: `Select a set to filter OAI-PMH results (${Object.keys(sets).length} sets available):`,
          },
          styles: { marginBottom: "10px" },
        });
              ...
              listeners: [
                {
                  ...
                  listener: (e: Event) => {
                    ...
                    const selectButton = doc.getElementById(
                      "select",
                    ) as HTMLButtonElement | null;
        ...
        if (dialogWindow && dialogWindow.window) {
          ...
          ztoolkit.log(
            "Error: OAI Sets Dialog window reference not found after open().",
            "error",
          );
        }
      ...
      ztoolkit.log(
        `${logPrefix} Setting initial visibility for protocol: ${dialogData.protocol}`,
      );
      updateVisibility(dialogData.protocol);
    ...
    ztoolkit.log(
      "Initialization Error: dialogHelper.window is not available immediately after open().",
      "error",
    );
  }
