...
export function ensureEnvironment() {
  try {
    ...
    if (
      ...
      if (mainWindow) {
        ...
        if (!(mainWindow as any).window2) {
          ...
          if (typeof Zotero !== "undefined") {
            Zotero.debug(
              "[LibrarySearch] Added window2 reference to main window",
            );
          }
        }
        ...
        if (typeof globalThis !== "undefined") {
          ...
          if (!global.addEventListener && mainWindow.addEventListener) {
            ...
            if (typeof Zotero !== "undefined") {
              Zotero.debug(
                "[LibrarySearch] Added addEventListener to globalThis",
              );
            }
          }
          ...
          if (!global.removeEventListener && mainWindow.removeEventListener) {
            ...
            if (typeof Zotero !== "undefined") {
              Zotero.debug(
                "[LibrarySearch] Added removeEventListener to globalThis",
              );
            }
          }
          ...
          if (global._console === undefined) {
            ...
            if (typeof Zotero !== "undefined") {
              Zotero.debug(
                "[LibrarySearch] Added _console reference to globalThis",
              );
            }
          }
        }
        ...
        if (typeof _globalThis !== "undefined") {
          ...
          if (!global.addEventListener && mainWindow.addEventListener) {
            ...
            if (typeof Zotero !== "undefined") {
              Zotero.debug(
                "[LibrarySearch] Added addEventListener to _globalThis",
              );
            }
          }
          ...
          if (!global.removeEventListener && mainWindow.removeEventListener) {
            ...
            if (typeof Zotero !== "undefined") {
              Zotero.debug(
                "[LibrarySearch] Added removeEventListener to _globalThis",
              );
            }
          }
          ...
          if (!global.dispatchEvent && mainWindow.dispatchEvent) {
            ...
            if (typeof Zotero !== "undefined") {
              Zotero.debug(
                "[LibrarySearch] Added dispatchEvent to _globalThis",
              );
            }
          }
          ...
          if (global._console === undefined) {
            ...
            if (typeof Zotero !== "undefined") {
              Zotero.debug(
                "[LibrarySearch] Added _console reference to _globalThis",
              );
            }
          }
        }
        ...
        Zotero.debug(
          "[LibrarySearch] Could not get main window, some polyfills might not work",
        );
      }
    }
    ...
    if (typeof Zotero !== "undefined") {
      Zotero.debug(
        "[LibrarySearch] Environment polyfills initialized successfully",
      );
    }
  } catch (e) {
